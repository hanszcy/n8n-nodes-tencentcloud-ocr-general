...
exports.TencentCloudOCRGeneralApi = void 0;
class TencentCloudOCRGeneralApi {
    constructor() {
        this.name = 'tencentCloudOCRGeneralApi';
        this.displayName = 'Tencent Cloud OCR General API';
        this.documentationUrl = 'https://cloud.tencent.com/document/product/866';
        this.properties = [
            {
